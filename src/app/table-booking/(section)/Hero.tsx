const Hero = ({ }) => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(170deg, rgba(0, 0, 0, 0.00) 7.51%, rgba(0, 0, 0, 0.80) 92.93%), url(/images/table-booking/nils-stahl-BCkLxilDvJU-unsplash.jpg) lightgray 50% / cover no-repeat",
      }}
    >
