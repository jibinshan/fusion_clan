                            ...
                            <div className="bg-[#0f0f0f] h-full w-full lg:w-[90%] flex items-center justify-center">
                                <div className="flex flex-col gap-5 px-2 lg:px-0 py-6">
                                    <p className="text-[#C1C1C1] font-gotu text-3xl lg:text-5xl">Reserve<br />
                                        Your Table</p>
                                    <p className="w-fit lg:w-[400px] text-[#BBB4AA] font-poppins">Discover the vibrant flavors of Fusion Clan, where traditional and modern cuisines blend in every dish. Reserve your table today to experience an unforgettable culinary journey.</p>
                                    <Link href='/table-booking'>
                                        <Button className="flex items-center justify-center gap-3 px-10 py-7">Book Table</Button>
                                    </Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-[#0f0f0f] h-full w-full lg:w-[90%] flex items-center justify-center">
                                <div className="flex flex-col gap-5 px-2 lg:px-0 py-6">
                                    <p className="text-[#C1C1C1] font-gotu text-3xl lg:text-5xl">Experience
                                        <br />
                                        the Flavors</p>
                                    <p className="w-full lg:w-[400px] text-[#BBB4AA] font-poppins">Indulge in a world of rich, authentic flavors crafted to excite your palate. Experience the fusion of tradition and innovation in every bite, only at Fusion Clan.</p>
                                    <Link href='/table-booking'>
                                        <Button className="flex items-center justify-center gap-3 px-10 py-7">Book Table</Button>
                                    </Link>
                                </div>
